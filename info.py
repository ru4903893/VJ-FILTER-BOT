...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002280361394 -1002426456651 -1002282708215')).split()]  # For Multiple Id Use One Space Between Each.
