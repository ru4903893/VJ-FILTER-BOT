...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1275850738').split()]  # For Multiple Id Use One Space Between Each.
