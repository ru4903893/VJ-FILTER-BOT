...
BOT_TOKEN = environ.get('BOT_TOKEN', "7997638482:AAGxyJM8oDaeXHlrZJfOK3Nt78OS6jdSVng")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7273878841').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002280361394')).split()]  # For Multiple Id Use One Space Between Each.
